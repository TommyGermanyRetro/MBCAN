...
Durch die Beschäftigung mit moderner Prozessoren wie ESP32 und RP2040 habe ich neue Motivation für das Projekt gefunden und portiere gerade die 3. Generation Arduino IDE tauglich auf dei Prozessoren ATMEGA644P (wie bei der 3. Generation), den ESP32-C3, den Waveshare RP2040 Zero und den RP RP2040 Pi Pico. Diese Versionen bezeichne ich als 4. Geneartion.

Passend dazu wird es ein erweitertes Parametriercenter geben, welches auch das Firmwareupdate der neuen Prozessoren über den CAN-Bus ermöglicht. Dazu wird die OTA-Funltionalität genutzt. Die Sketche werden hier im Git Stück für Stück veröffentlicht. Reale Umsetzugen werde ich für den ESP32-C3 in Eagle erstellen und gleichfalls hier poste. Nur die Bedienungsanleitungen, die ich früher mal geschrieben habe, wird es nicht mehr geben.